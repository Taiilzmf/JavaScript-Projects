//lets variable keep track of whose turn it is//
let activePlayer = 'X';
//array stores an array of moves. use this to determine win conditions//
let selectedSquares = [];
...
//draw line function also called//
...
//function clears canvass after win//
function clear() {
...
//function resets the game in the event of a tie or win//
function resetGame() {
  for (let i = 0; i < 9; i++) {
